function [net]=train_pu_patch(imdb)
...
trainOpts.expDir='data/test_pu_patch' ;
...
net=dagnn.DagNN();
net.addLayer('conv1',dagnn.Conv('size',[4 4 103 200], 'hasBias', 'true','stride', [1, 1],...
...
net.addLayer('classifier',dagnn.Conv('size',[4 4 200 9], 'hasBias', 'true','stride', [1, 1],...
